...
class AlipayTradeService {
	...
	function writeLog($text) {
		...
		//$text = characet ( $text );
		// file_put_contents ( dirname ( __FILE__ ).DIRECTORY_SEPARATOR."./{{src}}/log.txt", date ( "Y-m-d H:i:s" ) . "  " . $text . "\r\n", FILE_APPEND );
		file_put_contents ( ICUNJI.'/vendor/alipay/logs/notify.log', date ( "Y-m-d H:i:s" ) . "  " . $text . "\r\n", FILE_APPEND );
	}
}
